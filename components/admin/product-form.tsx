...
import { PIZZA_CATEGORIES, productDefualtValues } from "@/lib/constants";
    ...
    <Form {...form}>
      ...
      >
              ...
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input
                    ...
                    list="pizza-category-options"
                    {...field}
                  />
                </FormControl>
                <datalist id="pizza-category-options">
        ...
        <div>
          ...
          >
            {form.formState.isSubmitting ? "Submitting" : `${type} Menu Item`}
          </Button>
        </div>
      </form>
    </Form>
